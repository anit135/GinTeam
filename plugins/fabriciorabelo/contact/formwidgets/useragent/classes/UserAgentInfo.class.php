 ...
 *
 * ->isBanned() - it's a bot you probably want to ban right away; it may be an e-contact scrapper, fake user agent (someone is trying to conceal his identity), etc.
 *
 ...
 *
 * @author Mikołaj Misiurewicz <quentin389+uai@gcontact.com>
 *
